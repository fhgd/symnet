...
[       -G_R3        -G_R2  G_R2 + G_R3] [ V_IQ]   =   -FM*IQ - IQ
    """
    return g, ctrl_src, tree, result
...
[       -G_R3        -G_R2  FM + 1] [ I_VQ]   =   -G_R2*VQ - G_R3*VQ
    """
    return g, ctrl_src, tree, result
...
[        G_R2         G_R3  G_R2 + G_R3  FM + 1] [ V_FM]   =     0
[          -1           -1           -1       0] [ I_VQ]   =   -VQ
    """
    return g, ctrl_src, tree, result
...
[               G_R1 + G_R2  G_R1 + G_R2] [ V_GM]   =    -GM*VQ + G_R1*VQ
    """
    return g, ctrl_src, tree, result
...
def test_cut_v_trEv_tr_2():
    ...
    result = """
[ G_R1 + G_R2 + G_R3 + G_R4] [ V_R4]   =   -EM*G_R1*VQ - EM*G_R2*VQ + G_R1*VQ + G_R3*VQ
    """
    return g, ctrl_src, tree, result
...
[          -1           -1  0                    -HM] [ I_VQ]   =   -VQ
[        G_R2         G_R3  1  G_R2*HM + G_R3*HM + 1] [ I_HM]   =     0
    """
    return g, ctrl_src, tree, result
...
[              -G_R1 - G_R3       -G_R1*HM + 1] [ I_VQ]   =   -G_R1*VQ - G_R3*VQ
    """
    return g, ctrl_src, tree, result
...
def test_cut_v_trHi_tr_3():
    ...
    result = """
[ G_R1 + G_R2 + G_R3 + G_R4      G_R1*HM + G_R2*HM] [ V_R4]   =   G_R1*VQ + G_R3*VQ
[               G_R1 + G_R2  G_R1*HM + G_R2*HM + 1] [ I_HM]   =             G_R1*VQ
    """
    return g, ctrl_src, tree, result
